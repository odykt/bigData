...
# Load or build Bow
# -----------------------
print("light pruning, min df=2, max df = .9")
bowReady = False
if not bowReady:
    bow_vectorizer = CountVectorizer(min_df=2, max_df=0.9)  # speed/quality win
...
#Mean CV accuracy: 0.9539651141880956 +/- 0.0010512387630328315
#
#Overall classification report (aggregated over folds):
